...
def get_morning_report():
    ...
    try:
        ...
        # Obtenemos el resumen del día, aquí suele estar el RHR
        try:
...
# --- LÓGICA DE CARRERAS ---
# (Mismo código de procesamiento de actividades que ya funciona perfecto)
...
def telegram_webhook(request):
    ...
    try:
        ...
        help_msg = (
            ...
            "🔢 `0` : Reporte detallado de actividad."
        )
